...
**Updated:** 2026-01-12 (v1.4.0)
**Author:** David Oliver
**Repository:** https://github.com/DavidROliverBA/obsidian-architect-vault-template

> **Latest Release:** See [BLOG_POST_v1.4.0.md](BLOG_POST_v1.4.0.md) for the v1.4.0 announcement with Hybrid Graph Index System, 38 skills, and instant queries.
...
- Hybrid Graph Index System for instant queries
...
**Version:** v1.4.0 (2026-01-12)
**Original Release:** v1.0.0 (2026-01-07)
**See also:** [v1.4.0 Announcement](BLOG_POST_v1.4.0.md)
